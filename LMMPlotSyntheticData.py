...
plt.scatter(data_1['x'], data_1['y'], label='Individual 1', alpha=0.5)
plt.plot(data_1['x'], predictions_1, label='Prediction individual 1')

# Plotting for dataset 2
plt.scatter(data_2['x'], data_2['y'], label='Individual 2', alpha=0.5)
plt.plot(data_2['x'], predictions_2, label='Prediction individual 2')

plt.xlabel('x')
plt.ylabel('y')
plt.title('Different offset for each individual')
plt.legend()
plt.show()
...
plt.xlabel('x')
plt.ylabel('y')
plt.title('Combined dataset with prediction line')
plt.legend()
plt.show()
...
plt.xlabel('x', fontname="Times New Roman", fontsize=14)
plt.ylabel('y', fontname="Times New Roman", fontsize=14)
plt.title('Different offset for each individual', fontname="Times New Roman", fontsize=16)
...
plt.xlabel('x', fontname="Times New Roman", fontsize=14)
plt.ylabel('y', fontname="Times New Roman", fontsize=14)
plt.title('Combined dataset with prediction line', fontname="Times New Roman", fontsize=16)
plt.legend(fontsize=14)
plt.xticks(fontsize=12, family='Times New Roman')
plt.yticks(fontsize=12, family='Times New Roman')
plt.show()
